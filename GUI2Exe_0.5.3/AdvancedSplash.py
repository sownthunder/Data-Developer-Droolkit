...
# $Date: 2011-08-24 00:00:52 +0200 (Wed, 24 Aug 2011) $
# $Author: andrea.gavana $
# $Revision: 81 $
# $URL: https://gui2exe.googlecode.com/svn/trunk/AdvancedSplash.py $
# $Id: AdvancedSplash.py 81 2011-08-23 22:00:52Z andrea.gavana $
########### GUI2Exe SVN repository information ###################
...
class AdvancedSplash(wx.Frame):
    ...
    def __init__(self, parent, id=-1, pos=wx.DefaultPosition, size=wx.DefaultSize,
        ...
        * bitmap: this must be a valid ``wx.Bitmap``, that you may construct using
        ...
        * timeout: if you construct ``AdvancedSplash`` using the style ``AS_TIMEOUT``,
          ``AdvancedSplash`` will be destroyed after "timeout" milliseconds;

        * extrastyle: this value specifies the ``AdvancedSplash`` styles:
        
          - ``AS_TIMEOUT``: ``AdvancedSplash`` will be destroyed after "timeout" milliseconds;
        ...
        * shadowcolour: if you construct ``AdvancedSplash`` using the style
