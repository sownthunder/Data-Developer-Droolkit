...
if __name__ == "__main__":  # {
    ...
    try:  # {
        ...
        f1 = pd.Series(f_set_diff_df[1])
        g1 = pd.Series(g_set_diff_df[1])
        # FOR EACH ROW IN THE COLUMN
        for row in f1:  # {
            # CREATE FILE PATH VAR
            the_file_path = Path(row)
            print("THE FILE == " + str(the_file_path))
            ...
            print("THE TIME STAMP == " + str(the_ts))
    ...
    # }
        ...
        print("{Timestamp-Filename-Table] FIN...")
    # }
    """
    ###########################
